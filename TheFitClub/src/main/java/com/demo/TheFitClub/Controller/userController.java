...
public class userController {
    ...
    //USERS DETAILS BY ID
		...
		Optional<users> u=userservice.getById(user_id);
			if(u!=null)
   ...
   //USER REGISTRATION
    	...
    	public ResponseEntity<String> updateUserTrainerId(@PathVariable("user_id") int user_id,@PathVariable("trainer_id")int trainer_id){
